...
contract CrossChainTest is Test {
    ...
    function bridgeTokens(
        ...
        Register.NetworkDetails memory remoteNetowrkDetails,
        ...
        uint256 fee =
            IRouterClient(localNetworkDetails.routerAddress).getFee(remoteNetowrkDetails.chainSelector, message);
        ...
        vm.prank(user);
        IRouterClient(localNetworkDetails.routerAddress).ccipSend(remoteNetowrkDetails.chainSelector, message);
